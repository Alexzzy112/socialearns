...
import { HiCash, HiArrowRight, HiUpload, HiCurrencyDollar, HiCheckCircle, HiX, HiShieldCheck } from 'react-icons/hi';
      ...
      {showFund && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setShowFund(false)}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-md w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium mb-2">Upload Payment Receipt (Screenshot)</label>
              <div
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {receipt ? receipt.name : 'Click to upload receipt screenshot'}
                </p>
                <input
                  id="receipt-input"
                  type="file"
            ...
            >
              {submitting ? (
                ...
                <><HiCheckCircle className="w-5 h-5" /> Submit Deposit Request</>
              )}
            </button>
